...
import spaceships.*;
import sounds.ButtonAudioPlayer;
...
class SpaceShipSelectButtonHandler implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(name.equalsIgnoreCase("ZERO")) SpaceFrame.playScreen.setSpaceShips(new SpaceShipZERO());
		if(name.equalsIgnoreCase("ALPHA")) SpaceFrame.playScreen.setSpaceShips(new SpaceShipALPHA());
		if(name.equalsIgnoreCase("BETA")) SpaceFrame.playScreen.setSpaceShips(new SpaceShipBETA());
		if(name.equalsIgnoreCase("GAMA")) SpaceFrame.playScreen.setSpaceShips(new SpaceShipGAMA());
		if(name.equalsIgnoreCase("DELTA")) SpaceFrame.playScreen.setSpaceShips(new SpaceShipDELTA());
