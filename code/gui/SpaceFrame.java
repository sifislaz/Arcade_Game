...
public class SpaceFrame extends JFrame{
	...
	static WinnerScreen winScreen = new WinnerScreen();
	static LoserScreen loseScreen = new LoserScreen();
	...
	void setupMasterPanel() {
		...
		spaceFramePanel.add(winScreen);
		spaceFramePanel.add(loseScreen);
